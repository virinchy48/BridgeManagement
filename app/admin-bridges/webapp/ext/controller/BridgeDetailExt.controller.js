sap.ui.define([
...
], function (PageController, JSONModel, MessageToast, CaptureCondition, RiskAssessmentsExt, BridgeInspectionsExt) {
  "use strict";
  ...
  return PageController.extend("BridgeManagement.adminbridges.ext.controller.BridgeDetailExt", {
    ...
    // ── CaptureCondition delegation wrappers ─────────────────────────────────
    ...
    // ── RiskAssessmentsExt delegation wrappers ───────────────────────────────

    onOpenInherentMatrix: function (oEvent) {
      RiskAssessmentsExt.prototype.onOpenInherentMatrix.call(this, oEvent);
    },

    onOpenResidualMatrix: function (oEvent) {
      RiskAssessmentsExt.prototype.onOpenResidualMatrix.call(this, oEvent);
    },

    // ── BridgeInspectionsExt delegation wrapper ──────────────────────────────

    onOpenBatchElementEntry: function (oEvent) {
      BridgeInspectionsExt.prototype.onOpenBatchElementEntry.call(this, oEvent);
    },
