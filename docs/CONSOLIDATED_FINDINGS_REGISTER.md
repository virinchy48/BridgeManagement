...
*Generated: 2026-05-14 | Updated: 2026-05-14 | Total: 18 | Critical: 2 | High: 7 | Medium: 6 | Low: 3 | **Fixed (full): 18 | Open: 0***
...
- **Severity**: CRITICAL
- **Status**: ✅ FIXED — @restrict added to all 7 entities
...
- **Severity**: HIGH
- **Status**: ✅ FIXED — regex match pattern applied
...
- **Severity**: MEDIUM
- **Status**: ✅ FIXED — DemoData.view.xml + DemoData.controller.js deleted
...
|---|---|---|---|
| BMS-2026-001 | CRITICAL | ✅ FIXED | Unprotected Write Access to 7 AdminService Entities |
| BMS-2026-002 | CRITICAL | ✅ FIXED | Inspector Accreditation Level Check Allows Null Bypass |
| BMS-2026-003 | HIGH | ✅ FIXED | INS- Sequence Uses String Replace — NaN Risk |
| BMS-2026-004 | HIGH | ✅ FIXED | Australian Coordinate Bounds Not Enforced at DB Level |
| BMS-2026-005 | HIGH | ✅ FIXED | Reports API and BHI/BSI API Lack Scope Enforcement |
| BMS-2026-006 | HIGH | ✅ FIXED | Attributes API Lacks Scope Enforcement for Mutations |
| BMS-2026-007 | HIGH | ✅ FIXED | KPI Snapshot lrcExpiringCount Ignores State Filter |
| BMS-2026-008 | HIGH | ✅ FIXED | TfNSW Condition Scale Threshold Mismatch in Reports API |
| BMS-2026-009 | MEDIUM | ✅ FIXED | Auto-Created Restriction Missing Mandatory Fields |
| BMS-2026-010 | MEDIUM | ✅ FIXED | KPI Snapshot N×5 Per-State Queries Instead of Batch |
| BMS-2026-011 | MEDIUM | ✅ FIXED | Dead DemoData Files Remain After Demo Mode Removal |
| BMS-2026-012 | MEDIUM | ✅ FIXED | elementHealthRating Formula Counter-Intuitive Direction |
| BMS-2026-013 | MEDIUM | ✅ FIXED | CSRF Fallback to 'unsafe' Token in Controllers |
| BMS-2026-014 | MEDIUM | ✅ FIXED | KPI Overdue Inspection Threshold Hardcoded at 5 Years |
| BMS-2026-015 | LOW | ✅ FIXED | activeRestrictionCount Fires on All ObjectPage Navigations |
| BMS-2026-016 | LOW | ✅ FIXED | scoreAllBridges Loads Entire AssetIQScores Into Memory |
| BMS-2026-017 | LOW | ✅ FIXED | GISConfig hereApiKey Exclusion Not Verified in Exports |
| BMS-2026-018 | LOW | ✅ FIXED | elementHealthRating Formula Lacks Documentation |
